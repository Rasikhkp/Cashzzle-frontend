...
import { TCreateTransactionSchema, createTransactionSchema } from '@/lib/schema'
        ...
        <Dialog defaultOpen={true}>
            <DialogContent className="sm:max-w-[425px]">
                <DialogHeader>
                    ...
                    <DialogDescription>Ever wonder what it's like to rewrite the past? Here's your chance.</DialogDescription>
                </DialogHeader>
                <Form {...form}>
                    <form
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        ...
                                        <FormControl>
                                            <Select onValueChange={field.onChange} defaultValue={data.categoryId}>
                                                <SelectTrigger>
